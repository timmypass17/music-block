...
extension Level {
    static let all: [Level] = [
        Level(notes: Note.otherLevelZero, otherNotes: Note.otherLevelFour, enableFunctionBlock: false, available: true, completed: false, description: """
            ...
            """),
        Level(notes: Note.levelZero, otherNotes: Note.otherLevelTwo, enableFunctionBlock: false, available: false, completed: false,
              description: """
              ✅ Goal: Add the next few notes!
              """),
        Level(notes: Note.levelZero, otherNotes: Note.otherLevelThree, enableFunctionBlock: true, available: false, completed: false,
              description: """
              ...
              """),
        Level(notes: Note.levelZero, otherNotes: Note.otherLevelFour, enableFunctionBlock: true, available: false, completed: false,
              description: """
              ✅ Goal: Add a second staff!
              
              1. Add a second **Play Block**
              
              2. Add the remaining notes
              """),
        Level(notes: Note.levelZero, otherNotes: Note.otherLevelFive, enableFunctionBlock: true, available: false, completed: false,
              description: """
